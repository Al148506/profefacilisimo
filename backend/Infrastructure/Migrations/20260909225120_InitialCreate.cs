        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Lesson_Duration", "\"EstimatedDuration\" IS NULL OR \"EstimatedDuration\" > 0");
                    table.CheckConstraint("CK_Lesson_Level", "\"Level\" IN ('A2','B1','B2')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Activity_Content", "jsonb_typeof(\"Content\") = 'object'");
                    table.CheckConstraint("CK_Activity_Duration", "\"EstimatedDuration\" IS NULL OR \"EstimatedDuration\" > 0");
                    table.CheckConstraint("CK_Activity_Order", "\"Order\" >= 0");
                    table.CheckConstraint("CK_Activity_Type", "\"Type\" IN ('Speaking','Reading','Writing','VocabularyGrammar')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_UserId_UpdatedAt",
                table: "Lessons",
